 ...
 *
 * In the case of chotokkyu controllers, request-specific properties will be
 * assigned to each new instance, in order to avoid causing conflicts due to
 * concurrency.
 *
 * Example chotokkyu controller written in constructor style:
 *
 *     var Controller = require('chotokkyu').Controller
