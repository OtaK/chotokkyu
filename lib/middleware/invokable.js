 ...
 * a specific controller and action in a chotokkyu appliction.  This is
 * typically done to call into a chotokkyu application from middleware or routes
 ...
 * Examples:
 *
 *     this.polka.get(/regex/, function(req, res, next) {
