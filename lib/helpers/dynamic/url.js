 ...
 * in which case chotokkyu will introspect the record to build the
 * corresponding URL.
 *
 ...
 *
 * When taking advantage of model awareness, be sure to configure chotokkyu
 ...
 *
 *     this.datastore(require('chotokkyu-mongoose'));
 *
...
function urlFor(req) {
  ...
  return function(options) {
    ...
    options.controller = router.util.controllerize(options.controller) || req._chotokkyu.controller;
    options.action = router.util.functionize(options.action) || req._chotokkyu.action;
