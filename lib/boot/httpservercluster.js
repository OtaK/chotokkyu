 ...
 * Examples:
 *
 *   app.phase(chotokkyu.boot.httpServerCluster(8080));
 *
 *   app.phase(chotokkyu.boot.httpServerCluster(8080, '127.0.0.1'));
 *
 *   app.phase(chotokkyu.boot.httpServerCluster(8080, '127.0.0.1', { size: 8 }));
 *
 * @param {Number} port
