...
describe('helpers/route/pattern', function() {
  ...
  describe('path', function() {
    ...
    describe('without placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(patternHelper.path('/songs'), 'test', 'show')
          .req(function(req) {
    ...
    describe('with one placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(patternHelper.path('/songs/:id'), 'test', 'show')
          .req(function(req) {
            req.headers.host = 'www.example.com';
          })
          .create(function(err, helper) {
    ...
    describe('with one placeholder and one optional placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(patternHelper.path('/songs/:id.:format?'), 'test', 'show')
          .req(function(req) {
            req.headers.host = 'www.example.com';
          })
          .create(function(err, helper) {
    ...
    describe('with two placeholders', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(patternHelper.path('/bands/:band_id/albums/:id'), 'test', 'show')
          .req(function(req) {
            req.headers.host = 'www.example.com';
          })
          .create(function(err, helper) {
  ...
  describe('url', function() {
    ...
    describe('without placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.dynamicHelper(patternHelper.url('/songs', 'songs'), 'test', 'show')
          .app(function(app) {
    ...
    describe('with one placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.dynamicHelper(patternHelper.url('/songs/:id', 'song'), 'test', 'show')
          .app(function(app) {
    ...
    describe('with two placeholders', function() {
      ...
      before(function(done) {
        chai.chotokkyu.dynamicHelper(patternHelper.url('/bands/:band_id/albums/:id', 'bandAlbum'), 'test', 'show')
          .app(function(app) {
