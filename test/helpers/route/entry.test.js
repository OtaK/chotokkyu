...
describe('helpers/route/entry', function() {
  ...
  describe('Path', function() {
    ...
    describe('without placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('songs', 'index', [], true), 'test', 'show')
          .app(function(app) {
    ...
    describe('with one placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('songs', 'show', [ 'id' ], true), 'test', 'show')
          .app(function(app) {
    ...
    describe('with two placeholders', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('albums', 'show', [ 'band_id', 'id' ], true), 'test', 'show')
          .app(function(app) {
  ...
  describe('URL', function() {
    ...
    describe('without placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('songs', 'index', []), 'test', 'show')
          .app(function(app) {
            app.route('/songs', 'songs', 'index');
            app.dynamicHelper('urlFor', dynamicHelpers.urlFor);
          })
    ...
    describe('with one placeholder', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('songs', 'show', [ 'id' ]), 'test', 'show')
          .app(function(app) {
            app.route('/songs/:id', 'songs', 'show');
            app.dynamicHelper('urlFor', dynamicHelpers.urlFor);
          })
    ...
    describe('with two placeholders', function() {
      ...
      before(function(done) {
        chai.chotokkyu.helper(routeHelper('albums', 'show', [ 'band_id', 'id' ]), 'test', 'show')
          .app(function(app) {
            app.route('/bands/:band_id/albums/:id', 'albums', 'show');
            app.dynamicHelper('urlFor', dynamicHelpers.urlFor);
          })
